...
**[Download the Windows installer](https://github.com/Celobra/uo-asset-downloads/releases/download/uo-asset-studio-v0.27.0/UOAssetStudio-Setup-0.27.0.exe)** · [Complete PDF guide](https://uo-asset-library.farthrex.workers.dev/studio/guide/UOAssetStudio-User-Guide-0.27.0.pdf) · [Separate application source](https://github.com/Celobra/uo-asset-downloads/releases/download/uo-asset-studio-v0.27.0/UOAssetStudio-Source-0.27.0.zip)
...
Version 0.27.0 adds creature spells, healing, taming, custom attack effects and temporary summons, with eight editable presets and generated Sphere scripts. The guide now contains 62 pages.
